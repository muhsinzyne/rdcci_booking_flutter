...
class AppointmentStatusDetail extends StatefulWidget {
  final BookingData bookingData;

  const AppointmentStatusDetail({Key key, this.bookingData}) : super(key: key);
  @override
  _AppointmentStatusDetailState createState() => _AppointmentStatusDetailState();
}

class _AppointmentStatusDetailState extends State<AppointmentStatusDetail> {
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  AppointmentDetailTile(
                                    ...
                                    value: currentLanguage == 'en' ? this.widget.bookingData.bookingBranchEnglish : this.widget.bookingData.bookingBranchArabic,
                                  ),
//                                  AppointmentDetailTile(
...
//                                  ),
                                  AppointmentDetailTile(
                                    ...
                                    value: this.widget.bookingData.serviceNameForManage(this.currentLanguage),
                                  ),
                                ],
                              ),
                            ),
